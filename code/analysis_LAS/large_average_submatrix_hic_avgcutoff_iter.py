...
def large_average_submatrix_adj(data, chr1, chr2, threshold_new, max_submatrix_size, iters):
...
def run_LAS(pair, threshold_new, max_submatrix_size, iters):
    ...
    if (os.path.isfile(fname) == False):
        ...
        # run LAS algorithm
        start_rows, stop_rows, start_cols, stop_cols, best_score_list, avg_list = large_average_submatrix_adj(data, chr1, chr2, threshold_new, max_submatrix_size, iters)
