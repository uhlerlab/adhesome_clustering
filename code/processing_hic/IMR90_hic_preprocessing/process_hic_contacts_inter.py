...
def get_normed_hic_sparse(processed_hic_dir, cell_type, resol, quality, chr1, chr2, norm):
    '''
    ...
    normed_hic_dir = processed_hic_dir+'processed_hic_data_'+cell_type+'/normalized_BP'+str(resol)+'/'
    normed_mat_path = normed_hic_dir+'chr'+str(chr1)+'_chr'+str(chr2)+'_'+norm+'.txt'
...
def plot_dense_hic_dataframe(df, chr1, chr2, plotname, hic_plots_dir, show=False):
    '''
...
def main():
    ...
    final_hic_data_dir = processed_hic_data_dir+'processed_hic_data_'+hic_celltype+'/final_BP'+str(resol)+'_intra'+intra_norm+'_inter'+inter_norm+'/'
    ...
    for pair in chr_pairs:
        ...
        normalized_hic_data = get_normed_hic_sparse(processed_hic_data_dir, hic_celltype, resol, quality, chr1, chr2, inter_norm)
        ...
        picklename = final_hic_data_dir+'hic_'+'chr'+str(chr1)+'_'+'chr'+str(chr2)+'_norm1_filter3'+'.pkl'
