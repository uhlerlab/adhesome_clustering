...
def get_adhesome_genes_loci(adhesome_loc_df, resol):
    ...
    adhesome_loc_df.loc[:,'startLocus_id'] = list((adhesome_loc_df['genoStart']//resol))
    adhesome_loc_df.loc[:,'endLocus_id'] = list((adhesome_loc_df['genoEnd']//resol))
    adhesome_loc_df.loc[:,'startLocus'] = list((adhesome_loc_df['genoStart']//resol)*resol)
    adhesome_loc_df.loc[:,'endLocus'] = list((adhesome_loc_df['genoEnd']//resol)*resol)
    ...
    mask = adhesome_loc_df['startLocus']<adhesome_loc_df['endLocus']
    adhesome_loc_df.loc[mask,'startLocus_coverage'] = (adhesome_loc_df.loc[mask,'startLocus']+resol-adhesome_loc_df.loc[mask,'genoStart'])/resol
    adhesome_loc_df.loc[mask,'endLocus_coverage'] = (adhesome_loc_df.loc[mask,'genoEnd']-adhesome_loc_df.loc[mask,'endLocus'])/resol
...
def plot_heatmap(df, xticklabels, yticklabels, xlabel, ylabel, size, vmax, fontsize=3, save_to='', add_patches=[]):
    '''
